...
def main(verbose, storage_path, threshold):
    ...
    g1trx = controls.motors.Motor("X12DA-BNK-HE:G1_TRX", "g1trx")
    g1try = controls.motors.Motor("X12DA-BNK-HE:G1_TRY", "g1try")
    g1trz = controls.motors.Motor("X12DA-BNK-HE:G1_TRZ", "g1trz")
    g1rotx = controls.motors.Motor("X12DA-BNK-HE:G1_ROTX", "g1rotx")
    g1roty = controls.motors.Motor("X12DA-BNK-HE:G1_ROTY", "g1roty")
    g1rotz = controls.motors.Motor("X12DA-BNK-HE:G1_ROTZ", "g1rotz")
    g2trx = controls.motors.Motor("X22DA-BNK-HE:G2_TRX", "g2trx")
    g2try = controls.motors.Motor("X22DA-BNK-HE:G2_TRY", "g2try")
    g2trz = controls.motors.Motor("X22DA-BNK-HE:G2_TRZ", "g2trz")
    g2rotx = controls.motors.Motor("X22DA-BNK-HE:G2_ROTX", "g2rotx")
    g2roty = controls.motors.Motor("X22DA-BNK-HE:G2_ROTY", "g2roty")
    g2rotz = controls.motors.Motor("X22DA-BNK-HE:G2_ROTZ", "g2rotz")
